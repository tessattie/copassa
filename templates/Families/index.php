    ...
    <div class="panel-body articles-container">
            ...
            <?php foreach($families as $family) : ?>
                <tr>
                    ...
                    <td class="text-center"><?= $family->employee->first_name . " " .$family->employee->last_name ?></td>
                    <td class="text-center"><?= $family->employee->business->name ?></td>
                    <td class="text-center"><?= $family->employee->grouping->grouping_number ?></td>
