    ...
    <div class="panel-body articles-container">       
            ...
            <h4 style="padding: 10px;text-align: center;background: #f3f3f3;margin-bottom: 23px;">Profile</h4>
                <div class="row">
                    ...
                    <div class="col-md-3"><?= $this->Form->control('effective_date', array('class' => 'form-control', "type" => "date", "label" => "Effective Date *", "value" => date("Y-m-d"))); ?>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2"><?= $this->Form->control('deductible', array('class' => 'form-control', "value" => 0, 'placeholder' => 'deductible')); ?>
                    </div>
                    <div class="col-md-2"><?= $this->Form->control('usa_deductible', array('class' => 'form-control', "value" => 0, 'placeholder' => 'deductible')); ?>
                    </div>
